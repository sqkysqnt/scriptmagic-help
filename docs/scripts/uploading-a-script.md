...
Scripts in ScriptMagic are uploaded as PDF files. Each page is processed into an image for fast viewing and annotation.
...
1. Go to your production's edit screen
...
For example, if the first 5 pages of your PDF are front matter, set the offset to 5. That way, "Page 1" in ScriptMagic refers to what's actually the 6th page of the PDF.
