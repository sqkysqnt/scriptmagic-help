...
1. Open the Characters management screen
...
Select a character and click the trash button. The character will be unassigned from all people and removed from the production.
